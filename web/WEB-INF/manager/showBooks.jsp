...
<html>
<head>
	<link href="${pageContext.request.contextPath}/css2/hmstyle.css" rel="stylesheet" type="text/css"/>
...
<body class="am-container activity ">>
	...
	<div class="container-fluid">
		<div class="navbar-header">
			<a class="navbar-brand" href="${pageContext.request.contextPath }/admin/index"> <span
		...
		<ul class="nav navbar-nav navbar-right">
				...
				<c:if test="${not empty managerFlag }">
					<li><a >昵称：${managerFlag.nickname }</a></li>
					<li><a href="${pageContext.request.contextPath }/AdminLogoutController">注销</a></li>
				</c:if>
		...
		<div class="row">
			<div class="col-md-2">
				<div class="list-group">
					<a href="${pageContext.request.contextPath }/admin/index"
						...
						href="${pageContext.request.contextPath }/admin/QueryController"
						...
						href="${pageContext.request.contextPath}/admin/QueryBookController?pageNum=1"
			...
			<div class="alert alert-info" role="alert">
				...
				<table class="table table-hover">
					...
					<td>${book.author }</td>
					<td>${book.price }</td>
					<td><c:if test="${book.image_w !=null}">
					<img src="<%=path %>${book.image_w}" width=50 />
					</c:if>
					</td>
				
					<td>${book.category.name}</td>
					<td>
						<a href="${pageContext.request.contextPath }/admin/showBookDetail?bookId=${book.id}">查看</a>
						<a href="${pageContext.request.contextPath }/admin/updateBookIndex?bookId=${book.id}">修改</a>
						<a href="${pageContext.request.contextPath }/admin/deleteBook?bookId=${book.id}">删除</a>
					</td>
					</tr>
					</c:forEach>
				</table>
				...
				<ul style="float:right" class="pagination">
					...
					<c:forEach var="i" begin="1" end="${page.totalPage }"
						varStatus="status">
						<li><a href="${pageContext.request.contextPath }/admin/QueryBookController?pageNum=${status.index}">${status.index }</a></li>
					</c:forEach>
				</ul>
				</nav>
			</div>
