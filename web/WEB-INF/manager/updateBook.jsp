		...
		<div class="row">
			<div class="col-md-2">
				<div class="list-group">
					...
					<a href="${pageContext.request.contextPath }/admin/updateBookIndex?bookId=${book.id}"
						class="list-group-item active">更新图书</a>
				</div>
			</div>
			<div class="col-md-10">
				<form
					action="${pageContext.request.contextPath }/admin/updateBook?categoryId=${category.id}"
					...
					<div class="form-group">
						<%--@declare id="description"--%><label for="description">书籍描述</label>
