...
<body ng-app="itcast-shop" ng-controller="homeController" ng-init="homeSlider();todayProm()">
<div class="hmtop">
    <!--顶部导航条 -->
    ...
    <div class="nav white">
        ...
        <div class="search-bar pr">
            ...
            <form>
                <input id="searchInput" ng-model="searchEntity.productName" name="index_none_header_sysc" type="text" placeholder="搜索" autocomplete="off"/>
                <input id="ai-topsearch" class="submit am-btn" value="搜索" index="1" ng-click="search()"/>
            </form>
        </div>
    </div>
...
<div class="banner">
    <!--轮播 -->
    <div class="am-slider am-slider-default scoll homeSlider" data-am-flexslider id="demo-slider-0">
    ...
    <div class="slideall">
        ...
        <div class="marqueen">
            ...
            <div class="demo">
                ...
                <ul>
                    <li class="title-first"><a target="_blank" href="blog.html">
                    ...
                    <div class="mod-vip">
                        ...
                        <div class="member-logout">
                            ...
                            <a class="am-btn-warning btn" href="/Login">注册</a>
                        </div>
                    </div>

                    <li><a target="_blank" href="blog.html"><span>[特惠]</span>洋河年末大促，低至两件五折</a></li>
                    <li><a target="_blank" href="blog.html"><span>[公告]</span>华北、华中部分地区配送延迟</a></li>
                    <li><a target="_blank" href="blog.html"><span>[特惠]</span>家电狂欢千亿礼券 买1送1！</a></li>
...
<div class="shopMainbg">
    <div class="shopMain" id="shopmain">
        ...
        <div class="am-g am-g-fixed recommendation">
            ...
            <div class="am-u-sm-4 am-u-lg-3 " ng-repeat="content in contentList">
                <div class="info ">
                    <h3>{{content.name}}</h3>
                    <h4>{{content.title}}</h4>
                </div>
                <div class="recommendationMain {{numToEnglish[$index]}}">
                    <a href="{{content.url}}"><img src="{{content.img}}"></img></a>
                </div>
            </div>
    ...
    <div id="sidebar">
        <div id="wrap">
            <div id="prof" class="item ">
                <a href="# ">
                    <span class="setting" href="/Login"></span>
                </a>
                <div class="ibar_login_box status_login ">
                    <div class="avatar_box ">
                        ...
                        <ul class="user_info ">
                            ...
                            <li><a href="#">${customer.nickname }</a>Hi,你好</li>
                            </c:if>
                            <c:if test="${empty customer}">
                                <li><a href="/index" style="width: 50px">请登录</a></li>
                            </c:if>
                            <c:if test="${not empty customer}">
                                <li><a href="/LogoutController">注销</a></li>
                            </c:if>
                        </ul>
                    </div>
                </div>
...
<script>
    window.jQuery || document.write('<script src="../basic/js/jquery-3.4.1.min.js"><\/script>');
</script>
